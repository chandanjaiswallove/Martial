...
<div id="wrapper">
    ...
    <div class="header-top bg-blue-111 sm-text-center p-0">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="widget no-border m-0">
              <ul class="list-inline xs-text-center text-white mt-5">
                <li class="m-0 pl-10 pr-10"> <a href="#" class="text-white"><i class="fal fa-phone text-theme-colored"></i> 123-456-789</a> </li>
                <li class="m-0 pl-10 pr-10"> <i class="fal fa-clock text-theme-colored"></i> Mon-Fri 8:00 to 2:00 </li>
                <li class="m-0 pl-10 pr-10"> <a href="#" class="text-white"><i class="fal fa-envelope text-theme-colored"></i> <span class="__cf_email__" data-cfemail="cba8a4a5bfaaa8bf8bb2a4beb9afa4a6aaa2a5e5a8a4a6">[email&#160;protected]</span></a> </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-2">
            <a class="btn btn-colored btn-flat btn-theme-colored ajaxload-popup pb-10" href="assets/ajax-load/form-appointment.html">Free Consulting</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="main-content">
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider rev_slider_default" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/bg/bg13.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="assets/images/bg/bg13.jpg"  alt=""  data-bgposition="top 30%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white"
                  ...
                  style="z-index: 7; white-space: nowrap; font-weight:700;">Martial Arts
                </div>
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white bg-theme-colored-transparent pl-20 pr-20"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600;">Train with best Legends 
                </div>
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/bg/bg14.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                <img src="assets/images/bg/bg14.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase  bg-dark-transparent-6 text-white pl-30 pr-30"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:400; border-radius: 30px;">Martial Arts Academy 
                </div>
                ...
                <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white pl-30 pr-30"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">Train with best Legends 
                </div>
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/bg/bg12.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                <img src="assets/images/bg/bg12.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white bg-theme-colored-transparent pr-20 pl-20"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600;"> Martial Arts
                </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              ...
              <h2 class="mt-0">Welcome To Our<span class="text-theme-colored">Martial Art</span></h2>
              ...
              <div class="row multi-row-clearfix mt-30">
                <div class="col-sm-6 col-md-6">
                  <div class="icon-box mb-60">
                    <a href="#" class="icon icon-circled icon-bordered icon-gray icon-border-effect mb-0 mr-10 pull-left flip">
    ...
    <section class="">
      <div class="container bg-theme-colored pt-40 pb-30">
        <div class="section-content sm-text-center">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-white mt-0 ml-30">Martial art is a unique Web design template </h3>
            </div>
            <div class="col-md-4">
              <a class="btn btn-dark btn-flat " href="#">View More</a>
              <a class="btn btn-dark btn-flat ml-20" href="#">Register Now</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Section: Classes -->
    <section id="class" class="bg-lighter">
          ...
          <div class="row">
            <div class="col-sm-6 col-md-4 mb-30">
              <div class="class-items bg-white border-1px p-20">
                ...
                <h3 class="">
                <a href="#"><span class="text-theme-colored">Private </span> | Group Lessons</a></h3>
                <div class="class-date"><i class="fal fa-clock"></i> <em>01:00pm - 03:00 pm</em></div>
                <div class="class-date mb-10"><i class="far fa-location-dot"></i> <em> 121 King Street, Melbourne.</em></div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 mb-30">
              <div class="class-items bg-white border-1px p-20">
              ...
              <div class="owl-carousel-3col">
                <div class="item">
                  <div class="trainer-item style2">
                    <div class="trainer-thumb"> <img src="assets/images/team/1.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                    <div class="trainer-info pb-20">
                      <div class="trainer-biography">
                        <h3 class="text-white">Sara Lee</h3>
                ...
                <div class="item">
                  <div class="trainer-item style2">
                    <div class="trainer-thumb"> <img src="assets/images/team/2.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                    <div class="trainer-info pb-20">
                      <div class="trainer-biography">
                        <h3 class="text-white">Kettie Doe</h3>
                        <h5 class="text-white">Master</h5>
                      </div>
                      <div class="social-network pt-10">
                        <ul class="list-inline">
                ...
                <div class="item">
                  <div class="trainer-item style2">
                    <div class="trainer-thumb"> <img src="assets/images/team/3.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                    <div class="trainer-info pb-20">
                      <div class="trainer-biography">
                        <h3 class="text-white">Maggie Jones</h3>
                        <h5 class="text-white">Master</h5>
                      </div>
                      <div class="social-network pt-10">
                        <ul class="list-inline">
                ...
                <div class="item">
                  <div class="trainer-item style2">
                    <div class="trainer-thumb"> <img src="assets/images/team/4.jpg" alt="" class="img-fullwidth img-responsive"> </div>
                    <div class="trainer-info pb-20">
                      <div class="trainer-biography">
            ...
            <div class="col-md-12">
              ...
              <div class="gallery-isotope grid-4 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item design">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/1.jpg" alt="project">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/1.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item branding photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/2.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/2.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item design">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/3.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/3.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item branding">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/4.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/4.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item design photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/5.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/5.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/6.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/6.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item branding">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/7.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/7.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/8.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="assets/images/gallery/8.jpg" data-lightbox-gallery="gallery" title="Your Title Here"><i class="far fa-image"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item branding">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/9.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                ...
                <div class="gallery-item design photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/10.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                ...
                <div class="gallery-item photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/11.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                ...
                <div class="gallery-item branding">
                  <div class="thumb">
                    <img class="img-fullwidth" src="assets/images/gallery/12.jpg" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
    ...
    <section id="pricing" data-bg-img="assets/images/pattern/p3.png">
      <div class="container pb-40">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4 hvr-float-shadow mb-sm-30">
              <div class="pricing-table pb-0 mt-sm-0 maxwidth400 bg-lightest text-center">
                <img src="assets/images/pricing/1.jpg" alt="" class="img-fullwidth img-responsive">
                <div class="pricing-title bg-black p-20">
                  <h3 class="package-type text-uppercase letter-space-1 mt-0 text-white">Beginner</h3>
                ...
                <div class="price-amount font-36">
                  <div class="font-weight-700 text-theme-colored">$35* / <span class="font-14 text-uppercase">monthly</span></div>
                </div>               
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 hvr-float-shadow mb-sm-30">
              <div class="pricing-table pb-0 mt-sm-0 maxwidth400 bg-lightest text-center">
                ...
                <div class="pricing-title bg-theme-colored p-20">
                  <h3 class="package-type text-uppercase letter-space-1 mt-0 text-white">Pro</h3>
                  <h5 class="text-uppercase font-weight-400 text-white letter-space-1 mt-0">Training with Jon ismail</h5>
                </div>
                <div class="pricing-info">
                 <ul class="table-list list mt-0 no-bg no-border no-bullet">
                    <li>Free Consultation</li>
                ...
                <a href="#" class="btn btn-lg btn-dark text-uppercase btn-block pt-20 pb-20 btn-flat">Signup</a>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-4 hvr-float-shadow mb-sm-30">
              <div class="pricing-table pb-0 mt-sm-0 maxwidth400 bg-lightest text-center">
                <img src="assets/images/pricing/3.jpg" alt="" class="img-fullwidth img-responsive">
                <div class="pricing-title bg-black p-20">
                  <h3 class="package-type text-uppercase letter-space-1 mt-0 text-white">Premium</h3>
                  <h5 class="text-uppercase font-weight-400 text-gray letter-space-1 mt-0">Training with Jon ismail</h5>
                </div>
                <div class="pricing-info">
                 <ul class="table-list list mt-0 no-bg no-border no-bullet">
      ...
      <div class="container">
        <div class="section-ontent">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="icon-box border-bottom clearfix">
                ...
                <div class="ml-120 ml-sm-0">
                  <h4 class="icon-box-title mb-10">Tips and Advice</h4>
                  <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius. </p>
                </div>
              </div>
              <div class="icon-box border-bottom clearfix">
                <a href="#" class="icon icon-circled bg-theme-colored icon-lg pull-left flip sm-pull-none"> 
            ...
            <div class="col-md-6">
              <h3 class="line-bottom"> Event  <span class="text-theme-colored">Schedule</span> </h3>
              <div class="bxslider bx-nav-top" data-minslides="3">
                <div class="event media mb-20 no-bg no-border">
                  <div class="event-date media-left text-center flip bg-theme-colored p-20 pt-5 pb-5">
                    <ul>
                      <li class="font-30 text-white font-weight-600 border-bottom">02</li>
                      <li class="font-22 text-white text-uppercase">Jan</li>
                    </ul>
                  </div>
                  <div class="media-body pl-20">
                    <div class="event-content pull-left flip">
                      <h4 class="event-title media-heading"><a href="#">Gear up for giving</a></h4>
                      <span class="mb-10 text-gray-darkgray mr-10"><i class="fal fa-clock mr-5 text-theme-colored"></i> at 5.00 pm - 7.30 pm</span>
                      <span class="text-gray-darkgray"><i class="far fa-location-dot mr-5"></i> 25 Newyork City</span>
                      <p class="mt-5">Eos ei nisl graecis, vix aperiri consequat an. Eius lorem tincidunt vix at, alienum phaedrum torquatos nec eu.</p>
                    </div>
                  </div>
                </div>
                <div class="event media mb-20 no-bg no-border">
                  <div class="event-date media-left text-center flip bg-theme-colored p-20 pt-5 pb-5">
                    <ul>
                      <li class="font-30 text-white font-weight-600 border-bottom">16</li>
                ...
                <div class="event media mb-20 no-bg no-border">
                  <div class="event-date media-left text-center flip bg-theme-colored p-20 pt-5 pb-5">
                    <ul>
                      <li class="font-30 text-white font-weight-600 border-bottom">22</li>
                      <li class="font-22 text-white text-uppercase">Feb</li>
                    </ul>
                  </div>
                  <div class="media-body pl-20">
                ...
                <div class="event media mb-20 no-bg no-border">
                  <div class="event-date media-left text-center flip bg-theme-colored p-20 pt-5 pb-5">
                    <ul>
                      <li class="font-30 text-white font-weight-600 border-bottom">28</li>
                      <li class="font-22 text-white text-uppercase">Fab</li>
                    </ul>
                  </div>
                  <div class="media-body pl-20">
                    <div class="event-content pull-left flip">
                ...
                <div class="event media mb-20 no-bg no-border">
                  <div class="event-date media-left text-center flip bg-theme-colored p-20 pt-5 pb-5">
                    <ul>
                      <li class="font-30 text-white font-weight-600 border-bottom">28</li>
                      <li class="font-22 text-white text-uppercase">Sep</li>
                    </ul>
                  </div>
                  <div class="media-body pl-20">
                    <div class="event-content pull-left flip">
    ...
    <section id="blog" class="bg-lighter">
      <div class="container">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="title">News & <span class="text-theme-colored">blog</span></h2>
              <p class="">Join our martial art club and be healthy.</p>
            </div>
          </div>
        </div>
                ...
                <div class="item">
                  <article class="post clearfix maxwidth600 mb-sm-30">
                    <div class="entry-content bg-white border-1px p-20">
                      <h4 class="entry-title mt-0 pt-0"><a href="#">THIS IS A STANDARD POST WITH THUMBNAIL</a></h4>
                      <div class="entry-date"> 
                        <i class="fal fa-thumbs-up mr-5"></i> 245
                        <i class="fal fa-comments ml-5 mr-5"></i> 5 comments 
                        <i class="far fa-calendar-days ml-5 mr-5"></i> Nov 13, 2015 
                      </div>
                      <div class="thumb mt-20">
                        <img src="assets/images/news/1.jpg" alt="">
                      </div>
                      <p class="text-left mb-20 mt-15">Voluptatum esse repudiandae earum, unde odit quaerat animi facere aspernatur molestiae facilis expedita aut dolorem, deleniti necessitatibus! Quasi voluptas facilis eum odio expedita, facere, ex omnis placeat magni...</p>
  ...
  <footer id="footer" class="footer layer-overlay overlay-dark-9" data-bg-img="assets/images/bg/bg19.jpg">
      ...
      <div class="row border-bottom-black">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark"> 
            <img class="mt-10 mb-20" alt="" src="assets/images/logo-wide-white.png">            
            <p>203, Envato Labs, Behind Alis Steet, Melbourne, Australia.</p>
            <ul class="list-inline mt-5">
              <li class="m-0 pl-10 pr-10"> <i class="fal fa-phone text-theme-colored mr-5"></i> <a class="text-gray" href="#">123-456-789</a> </li>
              <li class="m-0 pl-10 pr-10"> <i class="fal fa-envelope text-theme-colored mr-5"></i> <a class="text-gray" href="#"><span class="__cf_email__" data-cfemail="7f1c10110b1e1c0b3f06100a0d1b10121e1611511c1012">[email&#160;protected]</span></a> </li>
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-black-777 m-0">Copyright &copy;2024 ThemeMascot. All Rights Reserved</p>
          </div>
